...
- **🧠 AI 기반 머리 움직임 추적**: MediaPipe Face Mesh를 활용한 정밀한 468개 얼굴 랜드마크로 머리 기울기 분석
- **🔄 하이브리드 시선 추정**: 머리 움직임(주요) + 눈의 상대적 위치(미세조정) + 의도성 분석을 결합
- **👁️ 실용적인 시선 감지**: 머리 끄덕임과 눈꺼풀 상태를 종합하여 자연스러운 시선 방향 추정
...
- [x] ✅ **머리 움직임 기반 시선 추적**: 머리 기울기와 눈의 상대적 위치를 종합한 실용적 시선 추정 완료
